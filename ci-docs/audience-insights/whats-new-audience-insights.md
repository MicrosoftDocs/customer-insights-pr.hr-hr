...
- **Obrada podataka dodanih na dodatne stranice**
...
- **Obogaćivanje afiniteta za robne marke dostupno na dodatnim tržištima**

  Proširujemo dostupnost obogaćivanja afiniteta za robne marke izvan Sjedinjenih Država na pet dodatnih tržišta: Kanadu, Australiju, Veliku Britaniju, Francusku i Njemačku. Ovim proširenjem možete obogatiti podatke klijenata lokalnim robnim markama na tim tržištima. Također ćemo obogatiti profile klijenata koji se nalaze na tim tržištima korištenjem lokalnih osobnih podataka iz značajke Microsoftove Graph.
  Za više informacija pogledajte [Obogaćivanje profila klijenata afinitetima za robne marke i interese](enrichment-microsoft-graph.md)
...
- **Obogaćivanje podacima tvrtke iz tvrtkeLeadspace**
  ...
  Odredite polja u objedinjenim profilima klijenata koja se koriste za traženje povezanih podataka o tvrtki iz tvrtke Leadspace. Nakon pokretanja postupka obogaćivanja B2B profili obogaćeni su dodatnim atributima, uključujući veličinu tvrtke, lokaciju, industriju i još mnogo toga.    
...
- **Preklapanje i razlikovanja segmenta**
  ...
  Preklapanje segmenata omogućava prikazati koliko i koji su klijenti slični za dva ili više segmenta. Na primjer, kako se segment s visokom potrošnjom preklapa s segmentom klijenata s velikim zadovoljstvom ili kako se segment gubitka klijenata preklapa sa segmentom klijenata s niskim zadovoljstvom. Osim toga, možete analizirati kako se preklapanje mijenja na temelju dodatnog atributa po vašem izboru.
...
- **Ažurirana vremenska traka i označavanje stranica u dodatku za karticu klijenta**
  ...
  Vremenska crta rješenja za programski dodatak za korisničke kartice podudara se s vremenskom linijom aktivnosti. Označavanje stranica vremenske trake poboljšano je i prikazuje do 50 aktivnosti odjednom. Također, omogućuje učitavanje dodatnih aktivnosti u vremenskoj traci.    
  Za dodatne informacije pogledajte [Dodatak za karticu klijenta](customer-card-add-in.md).
...
- **Izvoz u LiveRamp**
  ...
  Aktivirajte svoje podatke u usluzi LiveRamp® da biste se povezali s preko 500 platformi u digitalnim, društvenim i TV ekosustavima. Koristite svoje podatke u platformi LiveRamp za ciljanje, suzbijanje i personaliziranje oglasnih kampanja.    

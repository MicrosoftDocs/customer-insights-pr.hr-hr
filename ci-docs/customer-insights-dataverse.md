...
> [!NOTE]
> Ako vaše tvrtke ili ustanove već koriste Dataverse u svom klijentu, važno je imati na umu da [Dataverse stvaranje okruženja kontrolira administrator](/power-platform/admin/control-environment-creation). Na primjer, ako postavljate novo okruženje customer insights s računom tvrtke ili ustanove, a administrator je onemogućio stvaranje probnih okruženja Dataverse za sve osim za administratore, ne možete stvoriti novo probno okruženje.
> 

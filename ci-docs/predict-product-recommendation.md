...
- Vaše okruženje mora biti konfigurirano za primarni **cilj pojedinačnih** potrošača publika.
...
1. Nakon mapiranja aktivnosti u odgovarajući semantički tip odaberite **Dalje** da biste nastavili.
...
1. U koraku **Filtri proizvoda** odaberite između sljedećih mogućnosti.
...
1. Na stranici rezultata nalazi se pet primarnih odjeljaka podataka:
    ...
    U nastavku se nalaze čimbenici koji mogu utjecati na preporuke za proizvode koje generira model.
        - **Prošle transakcije**: Uzorke kupnje u prošlosti model je iskoristio za generiranje preporuka za proizvode. Na primjer, model može preporučiti *Miš s površinskim lukom* ako je netko nedavno kupio *Surface Book 3* i *Surface Pen*. Model je naučio da su u prošlosti mnogi klijenti kupili *Miš s površinskim lukom* nakon kupnje *Surface Book 3* i *Surface Pen*.
